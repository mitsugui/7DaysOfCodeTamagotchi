...
namespace TamagotchiApp.ConsoleUi.Controller;
...
internal class TamagotchiController
{
    ...
    public TamagotchiController(TamagotchiView view, TamagotchiService service, GptChatCompletionService gptService)
    {
        _view = view;
        _service = service;
